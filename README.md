...
SiteManager는 Laravel 프로젝트에 필요한 기본적인 사이트 관리 기능들을 제공합니다.
...
- Summernote 에디터 통합으로 풍부한 텍스트 편집 지원
- 파일 업로드 및 첨부파일 관리
...
- 확장 가능한 구조로 프로젝트별 커스터마이징 지원

## 설치방법

두 가지 설치 방법을 제공합니다:

### 🏢 Production/Pilot 환경 (Vendor 설치)

일반적인 Laravel 프로젝트에서 패키지를 사용하는 방법입니다.
...
### 👨‍💻 Package 개발 환경 (Development)

패키지 개발이나 기여를 위한 로컬 개발 환경 설정 방법입니다.
...
> **💡 개발 환경의 장점**: 패키지 수정 시 실시간으로 테스트 프로젝트에 반영됩니다.
